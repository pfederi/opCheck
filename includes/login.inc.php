<form action="" method="" accept-charset="utf-8" data-abide>
	<div class="email-field">
		...
		<small class="error">Um für Sie ein Profil anzulegen benötigen wir eine E-Mail-Adresse</small>
	</div>
	<div class="email-field">
	...
	<button type="submit" onclick="window.location.href='verifizierung'">Weiter</button>
</form>